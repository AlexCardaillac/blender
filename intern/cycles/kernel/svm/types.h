...
typedef enum NodeVolumePhase {
  NODE_VOLUME_HENYEY_GREENSTEIN,
  NODE_VOLUME_FOURNIER_FORAND,
} NodeVolumePhase;
...
#define CLOSURE_IS_VOLUME(type) (type >= CLOSURE_VOLUME_ID && type <= CLOSURE_VOLUME_SCATTERING_ID)
#define CLOSURE_IS_VOLUME_SCATTER(type) (type == CLOSURE_VOLUME_SCATTERING_ID)
#define CLOSURE_IS_VOLUME_ABSORPTION(type) (type == CLOSURE_VOLUME_ABSORPTION_ID)
#define CLOSURE_IS_HOLDOUT(type) (type == CLOSURE_HOLDOUT_ID)
#define CLOSURE_IS_PHASE(type) (type == CLOSURE_VOLUME_SCATTERING_ID)
