...
DefNode(ShaderNode,     SH_NODE_VOLUME_ABSORPTION,  def_absorption,         "VOLUME_ABSORPTION",  VolumeAbsorption, "Volume Absorption", "Absorb light as it passes through the volume")
